...
class Catalogo : AppCompatActivity() {
    ...
    var adapterS: SerieaAdapter? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        gridviewSeries.adapter = adapterS
    }

    fun cargarPeliculas() {
        peliculas.add(
            Contenido("Big Hero 6", R.drawable.bighero6,
        ...
        peliculas.add(
            Contenido("1917", R.drawable.disietenueve, R.drawable.disietenueveheader, "British trenches somewhere in France. World war has been going on for the third year,\n" +
        ...
        peliculas.add(
            Contenido("Leap year", R.drawable.leapyear, R.drawable.leapyearheader, "A woman who has an elaborate scheme to propose to her boyfriend on Leap Day, an Irish\n" +
        ...
        peliculas.add(
            Contenido("Men In Black", R.drawable.mib, R.drawable.mibheader,"Based off of the comic book. Unbeknownst to other people, there is a private agency code\n" +
        ...
        peliculas.add(
            Contenido("Toy Story", R.drawable.toystory, R.drawable.toystoryheader,"Toy Story is about the &#39;secret life of toys&#39; when people are not around. When Buzz\n" +
        ...
        peliculas.add(
            Contenido("Inception", R.drawable.inception, R.drawable.inceptionheader, "Dom Cobb is a skilled thief, the absolute best in the dangerous art of extraction, stealing\n" +
    ...
    fun cargarSeries() {
        series.add(Contenido("Dr. House", R.drawable.drhouse,R.drawable.househeader,"The series follows the life of anti-social, pain killer addict, witty and arrogant medical doctor Gregory\n" +
        ...
        series.add(Contenido("Smallville",R.drawable.smallville, R.drawable.smallvilleheader,"The numerous miraculous rescues by the local wonder boy Clark have aroused suspicions amongst\n" +
        ...
        series.add(Contenido("Dr. who",R.drawable.drwho,R.drawable.drwhoheader,"Traveling across time and space, the immortal time-lord known as &#39;The Doctor&#39; travels across the\n" +
        ...
        series.add(Contenido("Bones",R.drawable.bones,R.drawable.bonesheader,"Dr. Temperance Brennan is a brilliant, but lonely, anthropologist whom is approached by an\n" +
        ...
        series.add(Contenido("Suits",R.drawable.suits,R.drawable.suitsheader,"While running from a drug deal gone bad, brilliant young college dropout Mike Ross slips into a job\n" +
                ...
                "possible."))
        series.add(Contenido("Friends",R.drawable.friends,R.drawable.friendsheader,"Rachel Green, Ross Geller, Monica Geller, Joey Tribbiani, Chandler Bing and Phoebe Buffay are\n" +
    ...
    class PeliculaAdapter : BaseAdapter {
        ...
        constructor(contenido: ArrayList<Contenido>, context: Context?) : super() {
            this.peliculas = contenido
            this.context = context
        }

        override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
            var contenido = peliculas[position]
            var inflator = context!!.getSystemService(Context.LAYOUT_INFLATER_SERVICE) as LayoutInflater
            var vista = inflator.inflate(R.layout.contenido, null)
            vista.iv_movies.setImageResource(contenido.image)
            vista.tv_title.setText(contenido.name)

            vista.iv_movies.setOnClickListener() {
                var intent = Intent(context, DetalleContenido::class.java)
                intent.putExtra("name", contenido.name)
                intent.putExtra("image", contenido.image)
                intent.putExtra("header", contenido.header)
                intent.putExtra("sinopsis", contenido.sinopsis)
    ...
    class SerieaAdapter : BaseAdapter {
        ...
        constructor(contenido: ArrayList<Contenido>, context2: Context?) : super() {
            this.series = contenido
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
            ...
            var vista = inflator.inflate(R.layout.contenido, null)
            vista.iv_movies.setImageResource(pelicula.image)
            vista.tv_title.setText(pelicula.name)

            vista.iv_movies.setOnClickListener() {
                var intent = Intent(context2, DetalleContenido::class.java)
